...
function NavigationBar() {
    ...
    return (
        <>
            ...
            <nav className="bg-white w-full h-18 top-0 sticky z-50 border-b border-gray-200 px-4 md:px-8 py-4">
                <div className="mx-auto flex justify-between items-center relative z-50">
                    <div className="flex items-center">
                        <Link onClick={() => {}} to='/' className={location.pathname === "/" ? 'active' : ''}>
                            <img src="/oblivion-times-logo-full.png" width="100" />
                        </Link>
                    </div>

                    <div className="hidden md:flex space-x-8">
                        <ul className="flex space-x-4 font-sans text-sm text-primary">
                            <li>
                            ...
                            <li>
                                <Link onClick={() => {}} to='/essays' className={location.pathname === "/essays" ? 'text-accent font-medium' : ''}>
                                    Essays
                                </Link>
                            </li>
                            {/* <li>
                            ...
                            <li>
                                <Link onClick={() => {}} to='/about' className={location.pathname === "/about" ? 'font-medium text-accent' : ''}>
                                    About
                                </Link>
                            </li>
                        </ul>
                   ...
                   <div className="flex gap-2">
                       <Link 
                        ...
                        className="font-sans text-sm md:text-base bg-accent hover:bg-accent-light cursor-pointer text-white font-semibold px-5 py-2 rounded-md"
                        onClick={() => {}}
                        >
                            Join the Dispatch
                       </Link>
            ...
            <nav className={`
                    fixed top-18 left-0 w-full bg-white border-b border-gray-100 px-4 py-4 z-40 md:hidden 
