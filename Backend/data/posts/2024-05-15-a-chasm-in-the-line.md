...
{% figure caption:"Wave of human heartbeat. Not really how it technically looks like on an EKG machine but it is nice picture, right?" %}
![heart wave](/assets/images/heart-beat-wave-logo-line-vector.jpg "Source: https://www.vecteezy.com/")
{:.mdimagestyle}
{% endfigure %}

{% figure caption:"Wave of light" %}
![light waves](/assets/images/719829945b6fab2fd3871fbffb7189d6.jpg "Source: https://ar.inspiredpencil.com/pictures-2023/wavelength-of-light")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Ball projectile" %}
![projective motion](/assets/images/1000_F_578019189_A9D5746MAH03KVcH2lkGiHI2rddgmkna.jpg "Source: https://stock.adobe.com")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Lazarus and the Rich Man by Jocopo Bassano" %}
![Lazarus and the rich man](/assets/images/07b205e0802b9b87b4d1f5754036cb02.jpg "Source:https://pinterest.com")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Graph of a smooth function" %}
![projective motion](/assets/images/phpGgn5vP.png "Source: https://chegg.com")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Infinite discontinuity for function $y=f(x)=\frac{1}{x}$" %}
![Infinite discontinuity](/assets/images/symmetry-of-the-reciprocal-function.png "Source: https://storyofmathematics.com")
{:.mdimagestyle}
{% endfigure %}
...
![Function](/assets/images/58mSg.png "Source:https://tex.stackexchange.com")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Limits must coincide on both sides of the function" %}
![Function](/assets/images/how-to-find-a-limit-on-a-graph.png "Source:https://calcworkshop.com")
{:.mdimagestyle}
{% endfigure %}
...
{% figure caption:"Removable discontinuity" %}
![!\[Function\](/assets/images/RemovableDiscontinuity_700.svg "https://mathworld.wolfram.com")](/assets/images/sinx-over-x.svg "Source:https://www.sfu.ca/")
{:.mdimagestyle}
{% endfigure %}
